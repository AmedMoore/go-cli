...
//		-ldflags -X github.com/skyareas/go-cli.AppName=[NAME]
var AppName string

// AppVersion is the version of the App. Defaults to 0.1.0.
// This can be set at build time using
//		-ldflags -X github.com/skyareas/go-cli.AppVersion=[VERSION]
var AppVersion string

// AppBuild is the build time of the App. Defaults to modified time of the binary file.
// This can be set at build time using
//		-ldflags -X github.com/skyareas/go-cli.AppBuild=[BUILD]
var AppBuild string
